...
// const MongoClient = require("mongodb").MongoClient;
const uri = "mongodb://127.0.0.1:27017/jti_sheikh_lep_ba";
// const uri =
...
client.connect((err) => {
  const userCollection = client.db("jti_sheikh_lep_ba").collection("users");
  const adminCollection = client.db("jti_sheikh_lep_ba").collection("admins");
  const leadsCollection = client.db("jti_sheikh_lep_ba").collection("leads");
  const baWiseReportCollection = client
    .db("jti_sheikh_lep_ba")
